...
export const SERIES: SeriesConfig[] = [
  ...
  { id: "motogp", label: "MotoGP", shortLabel: "MGP", color: "#009688", colorDark: "#14B8A6", defaultOn: true },
  { id: "moto2", label: "Moto2", shortLabel: "M2", color: "#22C55E", colorDark: "#4ADE80", defaultOn: false },
  { id: "moto3", label: "Moto3", shortLabel: "M3", color: "#84CC16", colorDark: "#A3E635", defaultOn: false },
